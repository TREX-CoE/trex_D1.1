...
org files invoking the Emacs text editor from the command-line in the
...
Most of the codes of the \ac{CoE} are written in Fortran
...
hence the \ac{QMCkl} \ac{API} has to be compatible with the C language
