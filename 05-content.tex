...
usually better adapted than linear scaling algorithms, for which the
cost of reducing the arithmetic complexity is amortized by the large
reduction of the number of flops.
