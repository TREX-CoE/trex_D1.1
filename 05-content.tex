...
with 
  \[
  {\tP}_{i, \alpha, k, l+m} = \sum_{j=1}^{\Nel} {\tr}_{i,j,k}\,{\tR}_{j,\alpha,l+m}
  \]
...
\begin{figure}
  ...
  \end{center}
  \caption{\label{fig:speedup}Speed up obained after the re-expression of the three-body
    Jastrow factor.}
\end{figure}
The speed up is presented in figure~\ref{fig:speedup}. Further
